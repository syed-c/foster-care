...
export default function HomePage() {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#F5E9E2] via-[#E3B5A4]/10 to-[#F5E9E2] py-20 md:py-32 overflow-hidden">
            ...
            <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto mb-6">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-10 h-12 text-base border-2 focus:border-[#773344]"
                />
              </div>
              <Button 
                type="submit"
                size="lg"
                className="h-12 px-8 bg-gradient-to-r from-[#773344] to-[#E3B5A4] text-white hover:opacity-90"
              >
                Search
              </Button>
            </form>
            ...
            <div className="flex flex-wrap justify-center gap-3 text-sm">
              ...
              {['London', 'Manchester', 'Birmingham', 'Glasgow'].map((city) => (
                <Link 
                  ...
                  className="px-3 py-1 rounded-full bg-white hover:bg-[#773344]/10 transition-colors border border-gray-200"
                >
                  {city}
                </Link>
              ))}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card key={index} className="relative border-2 hover:border-[#773344] transition-all hover:shadow-lg">
                <CardHeader>
                  <div 
                ...
                <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-gradient-to-br from-[#773344] to-[#E3B5A4] flex items-center justify-center text-white font-bold">
                  {index + 1}
                </div>
              </Card>
            ))}
      ...
      {/* Featured Agencies */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-white to-[#F5E9E2]">
        <div className="container mx-auto px-4">
      ...
      {/* Resources Highlight */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#F5E9E2] to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button size="lg" asChild className="bg-gradient-to-r from-[#773344] to-[#E3B5A4]">
                <Link href="/resources">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <Card className="bg-gradient-to-br from-[#773344] to-[#E3B5A4] border-0 text-white">
            <CardContent className="p-8 md:p-12">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="bg-white text-[#773344] hover:bg-gray-100">
      ...
      <Link href={`/agency/${agency.id}`}>
        <CardHeader>
          <div className="flex items-start justify-between mb-4">
            <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-[#773344]/20 to-[#E3B5A4]/20 flex items-center justify-center">
              {agency.logo ? (
            ...
            {agency.featured && (
              <Badge className="bg-[#E3B5A4]">Featured</Badge>
            )}
          </div>
        ...
        <CardFooter>
          <Button variant="ghost" className="w-full group-hover:bg-[#773344]/10 group-hover:text-[#773344]">

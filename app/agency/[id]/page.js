    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5E9E2] to-white">
      ...
      <div className="container mx-auto px-4 -mt-32 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <h1 className="text-3xl font-bold text-[#2C2C2C] font-poppins gradient-text">
                          {agency.name}
                        </h1>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {agency.services.map((service, index) => (
                      <Badge
                        key={index}
                        variant="secondary"
                        className="text-sm py-2 px-4 glass"
                      >
                        {service}
                      </Badge>
                    ))}
          ...
          <div>
            {/* Contact Card */}
            <Card className="glass-strong rounded-3xl mb-6 top-20">
              <CardHeader>
                ...
                {agency.contact_email && (
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      ...
                      className="text-sm hover:text-[#773344] transition-colors"
                    >
                      {agency.contact_email}
                    </a>
                  </div>
                ...
                {agency.contact_phone && (
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      ...
                      className="text-sm hover:text-[#E3B5A4] transition-colors"
                    >
                      {agency.contact_phone}
                    </a>
                  </div>
                ...
                {submitSuccess ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-600">
                      The agency will get back to you soon.
                    </p>
                  </div>
                ) : (

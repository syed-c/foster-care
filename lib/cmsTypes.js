...
export const validatePageContent = (content) => {
  ...
  if (!content.slug || (!content.slug.trim && !content.slug.current?.trim())) {
    errors.slug = 'Slug is required';
  } else if (content.slug.trim && !content.slug.trim()) {
    errors.slug = 'Slug is required';
  } else if (content.slug.current && !content.slug.current.trim()) {
    errors.slug = 'Slug is required';
  }

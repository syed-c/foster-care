  ...
  region: {
    ...
    sections: [
      ...
      { 
        ...
        description: 'Benefits and support services available to foster carers',
      ...
      { 
        ...
        description: 'Cities with short reason text, optional population note',
      ...
      { 
        key: 'allowances', 
        label: 'Foster Allowances & Agency Support Info', 
        description: 'Bullet list: each bullet is a line of text',
      ...
      { 
        ...
        description: 'Text, optional name, optional role',
      ...
      { 
        ...
        description: 'Question + answer with FAQ Schema toggle',
      ...
      { 
        key: 'trustBar', 
        label: 'Local Authorities & Regulation Trust Bar', 
        description: 'Authority name, URL, Ofsted/regulation note, safeguarding note',
      ...
      { 
        ...
        description: 'Title, subtitle, primary CTA, secondary CTA (optional)',
      ...
      return {
        ...
        sections: [
          ...
          },
          {
            ...
            data: {
              title: `About Fostering in ${locationName}`,
              body: `<p>Welcome to our directory of foster agencies in ${locationName}. We've compiled a list of accredited and trusted agencies to help you start your fostering journey.</p>`
            }
          },
          {

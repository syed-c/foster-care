...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.warn('Supabase clients will not be available until environment variables are set.');
} else if (supabaseUrl.includes('your-project') || supabaseAnonKey.includes('your-')) {

...
export default function RegionPopularCitiesSection({ data, regionSlug }) {
  ...
  const title = data?.title || `Popular Cities in This Region`;
  const description = data?.description || `Explore fostering opportunities in key cities across this region`;
  const cities = data?.cities || [
    { 
      name: "Central Region", 
      link: "#", 
      population: "Varies", 
      reason: "The heart of the region with excellent fostering opportunities and strong community support." 
    },
    { 

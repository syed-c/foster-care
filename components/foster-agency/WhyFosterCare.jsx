export default function WhyFosterCare() {
  return (
    <section className="my-12 bg-[#FAF9F6] rounded-modern-lg p-8 md:p-12">
      <h2 className="text-3xl font-bold text-[#2C2C2C] mb-8 font-poppins">
        Why Foster Care Matters
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 className="text-xl font-semibold text-[#2C2C2C] mb-3 font-poppins">
            Providing Stability
          </h3>
          <p className="text-[#2C2C2C] font-inter">
